...
public class GenericModification implements Modification {
    ...
    // iTRAQ mods
    public static final GenericModification NTermITRAQ = new GenericModification("N-term iTRAQ", new Atom[]{Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.C, Atom.C, Atom.C, Atom.C, Atom.C13, Atom.C13, Atom.C13, Atom.N, Atom.N15, Atom.O}, new Atom[0], true, false);
    public static final GenericModification ITRAQ = new GenericModification("iTRAQ", new Atom[]{Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.H, Atom.C, Atom.C, Atom.C, Atom.C, Atom.C13, Atom.C13, Atom.C13, Atom.N, Atom.N15, Atom.O}, new Atom[0], false, false);
    public static final GenericModification MethylMethanethiosulfonate = new GenericModification("Methyl Methanethiosulfonate", new Atom[]{Atom.H, Atom.H, Atom.S, Atom.C}, new Atom[0], false, false);

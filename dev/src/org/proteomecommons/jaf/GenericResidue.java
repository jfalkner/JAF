...
public class GenericResidue implements Residue {
    ...
    static {
        ...
        allResidues.add(new GenericModifiedResidue(GenericResidue.K, GenericModification.ITRAQ));
        allResidues.add(new GenericModifiedResidue(GenericResidue.C, GenericModification.MethylMethanethiosulfonate));
        addNTermModification(GenericModification.NTermITRAQ);
        ...
        addNTermModification(GenericModification.NTermAcetylation);
        // allow for methylation
        addNTermModification(GenericModification.Methylation);
        // di-methylation
...
//        allResidues.add(new GenericModifiedResidue(Residue.Y, new GenericModification("C-term Amidation", new Atom[]{Atom.H, Atom.N}, new Atom[]{Atom.O}, false, true)));;
    ...
    /**
     *Modify all of the residues
     */
    public static void addNTermModification(Modification mod) {
        // modify all residues
        allResidues.add(new GenericModifiedResidue(Residue.A, mod));
        allResidues.add(new GenericModifiedResidue(Residue.C, mod));
        allResidues.add(new GenericModifiedResidue(Residue.D, mod));
        allResidues.add(new GenericModifiedResidue(Residue.E, mod));
        allResidues.add(new GenericModifiedResidue(Residue.F, mod));
        allResidues.add(new GenericModifiedResidue(Residue.G, mod));
        allResidues.add(new GenericModifiedResidue(Residue.H, mod));
        allResidues.add(new GenericModifiedResidue(Residue.I, mod));
        allResidues.add(new GenericModifiedResidue(Residue.K, mod));
        allResidues.add(new GenericModifiedResidue(Residue.L, mod));
        allResidues.add(new GenericModifiedResidue(Residue.M, mod));
        allResidues.add(new GenericModifiedResidue(Residue.N, mod));
        allResidues.add(new GenericModifiedResidue(Residue.P, mod));
        allResidues.add(new GenericModifiedResidue(Residue.Q, mod));
        allResidues.add(new GenericModifiedResidue(Residue.R, mod));
        allResidues.add(new GenericModifiedResidue(Residue.S, mod));
        allResidues.add(new GenericModifiedResidue(Residue.T, mod));
        allResidues.add(new GenericModifiedResidue(Residue.V, mod));
        allResidues.add(new GenericModifiedResidue(Residue.W, mod));
        allResidues.add(new GenericModifiedResidue(Residue.Y, mod));
    }
    ...
    public static Residue getResidueByName(String name) {
        ...
        // fall back on trying to parse the mass different
        String[] parts = name.split("\\(|\\)");
        // first part is letter
        Residue r = GenericResidue.getResidueByFASTAChar(parts[0].charAt(0));
        if (r == null) {
            r = new GenericResidue() {
        ...
        // get the mass shift
        double shift = 0;
        if (parts.length > 0 && parts[1].indexOf("-") != -1) {
            shift = -1 * Double.parseDouble(parts[1].replaceAll("-", ""));
        } else if (parts.length > 0 && parts[1].indexOf("+") != -1) {
            shift = Double.parseDouble(parts[1].replaceAll("\\+", ""));
        } else {
            shift = Double.parseDouble(parts[1]);
        }
        final double s = shift;
        final Residue res = r;

        ModifiedResidue mr = new ModifiedResidue() {
            ...
            public char getFASTAChar() {
                return res.getFASTAChar();
            }

            public double getMassInDaltons() {
                return res.getMassInDaltons() + s;
            }

            public String getName() {
                return res.getFASTAChar() + "(" + nf.format(s) + ")";
            }
        };
...
//            }
//        };
//        gr.setName(r.getName() + "(" + shift + ")");
//        gr.setFASTAChar(r.getFASTAChar());
        return mr;
    }
    ...
    public static void main(String[] args) throws Exception {
        Peptide p = new Peptide("K");
        System.out.println(p + ": " + p.getMass());
        p = new Peptide("X(+100)X(-100)");
        System.out.println(p + ": " + p.getMass());
    }
}